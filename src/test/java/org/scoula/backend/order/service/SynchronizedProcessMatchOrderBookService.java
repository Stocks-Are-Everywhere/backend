...
/**
 * 개별 종목의 주문장 - 시나리오 2: ConcurrentMap + Process Synchronized + MatchOrder Synchronized + PriorityQueue (AtomicReference On/Off)
 */
public class SynchronizedProcessMatchOrderBookService {
	...
	public SynchronizedProcessMatchOrderBookService(final String companyCode, TradeHistoryService tradeHistoryService,
	...
	/**
	 * 주문 매칭 처리 (synchronized 적용)
	 */
	private synchronized void matchOrders(final Queue<Order> existingOrders, final Order incomingOrder) {
