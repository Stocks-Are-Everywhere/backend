...
/**
 * 개별 종목의 주문장 - 시나리오 5: ConcurrentMap + Process ReentrantLock + MatchOrder Synchronized + PriorityQueue (AtomicReference On/Off)
 */
public class LockProcessSynchronizedMatchOrderBookService {
	...
	public LockProcessSynchronizedMatchOrderBookService(final String companyCode,
