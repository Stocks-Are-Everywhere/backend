...
/**
 * 개별 종목의 주문장 - 시나리오 1: ConcurrentMap + Process Synchronized + PriorityQueue (AtomicReference Off)
 */
public class SynchronizedProcessOrderBookService {
	...
	public SynchronizedProcessOrderBookService(final String companyCode, TradeHistoryService tradeHistoryService,
