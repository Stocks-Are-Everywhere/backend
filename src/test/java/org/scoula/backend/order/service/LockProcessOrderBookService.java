...
/**
 * 개별 종목의 주문장 - 시나리오 4: ConcurrentMap + Process ReentrantLock + PriorityQueue (AtomicReference On/Off)
 */
public class LockProcessOrderBookService {
	...
	public LockProcessOrderBookService(final String companyCode, TradeHistoryService tradeHistoryService,
