...
/**
 * 개별 종목의 주문장 - 시나리오 6: ConcurrentMap + Process ReentrantLock + MatchOrder ReentrantLock + PriorityQueue (AtomicReference On/Off)
 */
public class LockProcessLockMatchOrderBookService {
	...
	public LockProcessLockMatchOrderBookService(final String companyCode, TradeHistoryService tradeHistoryService,
